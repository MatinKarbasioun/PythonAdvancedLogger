"""
Django settings for DjangoAdvanceLogger project.
...
SECRET_KEY = 'django-insecure-^@fb(3&isn2evbqbf&v_i4-7=1*%9@nytjyirc&x7pt+5umjrz'
...
elsConf = ElasticSearchConf(hosts=["host:port"],
                            user="your username",
                            password="your password",
                            indicator="advance-logger",
                            maxConnection=10)
...
ROOT_URLCONF = 'DjangoAdvanceLogger.urls'
...
WSGI_APPLICATION = 'DjangoAdvanceLogger.wsgi.application'
